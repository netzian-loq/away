...
export const SERVICES: Service[] = [
  {
    ...
    description:
      "Our flagship service. We deliver a Custom Gaming OS (AwayOS) and a deep Windows tune in one — configuring dxgkrnl, the kernel and registry, stripping unnecessary scheduled tasks, services, devices and drivers. Ships with Away Utility pre-installed so you control drivers, wallpapers, game fixes and system tools from one clean interface.",
    features: [
